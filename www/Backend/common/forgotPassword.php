...
if (isset($postdata))
{
    ...
    while($row = mysql_fetch_array($retval))
    {
      ...
      if($count ==1){
        ...
        curl_setopt($ch, CURLOPT_POSTFIELDS, "username=tallysolutions&password=49332602&source=TALLYS&dmobile=91".$userNum."&message=Your+Password+for+Logging+into+DoctoeQuick+is:$userPass");
