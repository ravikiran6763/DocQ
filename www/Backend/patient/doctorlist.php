...
//GET ID OF THE SPECALITY FROM SPECILITY TABLE
  ...
  //IF SPECIALITY IS SELECTED
   $sqlresults = "select doctorFname,doctorLname,doctorPhone,doctorDegrees,practicingSince,onoff,(select avg(rating) from doctorRatings where doctorRatings.ratingTo=doctorDetails.doctorPhone) as ratings, (select count(*) from doctorRatings where doctorRatings.ratingTo=doctorDetails.doctorPhone) as totalRates from doctorDetails,doctor_onoff  where doctorDetails.doctorPhone = doctor_onoff.doctor_phno and doctorSpecialityId like '%$byspecial%'";
  }
}
elseif($bygender)
{
//IF GENDER IS SELECTED ENTER LOOP
  ...
  $sqlresults = "select doctorFname,doctorLname,doctorPhone,doctorDegrees,practicingSince,onoff,(select avg(rating) from doctorRatings where doctorRatings.ratingTo=doctorDetails.doctorPhone) as ratings, (select count(*) from doctorRatings where doctorRatings.ratingTo=doctorDetails.doctorPhone) as totalRates from doctorDetails  where doctorSex='$bygender' AND (doctorLanguage1 like  '%$bylanguage%' OR doctorLanguage2 like '%$bylanguage%')";
  }
  elseif($bystatus)
  {
  //GENDER AND STATUS SELECTED
  $sqlresults = "select doctorFname,doctorLname,doctorPhone,doctorDegrees,practicingSince,onoff,(select avg(rating) from doctorRatings where doctorRatings.ratingTo=doctorDetails.doctorPhone) as ratings, (select count(*) from doctorRatings where doctorRatings.ratingTo=doctorDetails.doctorPhone) as totalRates from doctorDetails,doctor_onoff where doctorSex='$bygender' AND doctorDetails.doctorPhone = doctor_onoff.doctor_phno and doctor_onoff.onoff='$bystatus'";
  }
  else
  {
...
//IF STATUS IS SELECTED ENTER LOOP
  ...
  $sqlresults = "select doctorFname,doctorLname,doctorPhone,doctorDegrees,practicingSince,onoff,(select avg(rating) from doctorRatings where doctorRatings.ratingTo=doctorDetails.doctorPhone) as ratings, (select count(*) from doctorRatings where doctorRatings.ratingTo=doctorDetails.doctorPhone) as totalRates from doctorDetails,doctor_onoff where doctorDetails.doctorPhone = doctor_onoff.doctor_phno AND doctor_onoff.onoff='$bystatus' AND (doctorLanguage1 like  '%$bylanguage%' OR doctorLanguage2 like '%$bylanguage%')";
  }
  else
  {
  //ONLY IF STATUS IS SELECTED
  $sqlresults = "select doctorFname,doctorLname,doctorPhone,doctorDegrees,practicingSince,onoff,(select avg(rating) from doctorRatings where doctorRatings.ratingTo=doctorDetails.doctorPhone) as ratings, (select count(*) from doctorRatings where doctorRatings.ratingTo=doctorDetails.doctorPhone) as totalRates from doctorDetails,doctor_onoff where doctorDetails.doctorPhone = doctor_onoff.doctor_phno AND doctor_onoff.onoff='$bystatus'";
	// echo $sqlresults;
   }
}
...
//ONLY IF LANGUAGE IS SELECTED
  $sqlresults = "select doctorFname,doctorLname,doctorPhone,doctorDegrees,practicingSince,onoff,(select avg(rating) from doctorRatings where doctorRatings.ratingTo=doctorDetails.doctorPhone) as ratings, (select count(*) from doctorRatings where doctorRatings.ratingTo=doctorDetails.doctorPhone) as totalRates from doctorDetails where doctorLanguage1 like  '%$bylanguage%' OR doctorLanguage2 like '%$bylanguage%'";
}
else
{
