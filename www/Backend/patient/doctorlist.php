...
//GET ID OF THE SPECALITY FROM SPECILITY TABLE
  ...
  $sqlresults = "select doctorFname,doctorLname,doctorPhone,doctorDegrees,practicingSince,onoff from doctorDetails,doctor_onoff  where doctorDetails.doctorPhone = doctor_onoff.doctor_phno and doctorSpecialityId like '%$byspecial%'";
  }
}
elseif($bygender)
{
