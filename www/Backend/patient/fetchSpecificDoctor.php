<?php
    ...
    header('Content-type: text/html; charset=utf-8');
        ...
        $doctorDetails = array();
		 ...
		 $sql = "select doctorPhone,docImage2,doctorFname,doctorMname,doctorLname,doctorDegrees,practicingSince,doctorFee,ratings,ratingCount,donoff.onoff from doctorDetails,doctor_onoff as donoff,favDoctors as fav,doctorImages where doctorImages.docPhone=doctorDetails.doctorPhone and donoff.doctor_phno=doctorDetails.doctorPhone and doctorDetails.doctorPhone='$loginphno' group by docPhone";
