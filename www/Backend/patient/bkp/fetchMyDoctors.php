	...
	header('Content-type: text/html; charset=utf-8');
	 $postdata = file_get_contents("php://input");
        ...
        while($row = mysql_fetch_assoc($retval))
        {
			...
			$sql1 ="select doctorPhone,doctorFname,doctorMname,doctorLname,doctorDegrees,practicingSince,ratings,ratingCount from doctorDetails,favDoctors where doctorDetails.doctorPhone='$doctorphone'";
