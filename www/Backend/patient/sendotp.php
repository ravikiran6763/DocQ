<?php
	...
	if(isset($postdata))
	{
		...
		curl_setopt($ch, CURLOPT_POSTFIELDS, "username=doctorquick&password=41587026&source=DRQUCK&dmobile=91".$request_phno."&message=Your+OTP+for+DoctorQuick+is+:+$rand");
