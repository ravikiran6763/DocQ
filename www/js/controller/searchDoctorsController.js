															 ...
															 $rootScope.onTimeout = function(){
																 ...
																 if($ionicHistory.currentStateName() === 'app.results'){
																	 ...
																	 noResponsePopup = $ionicPopup.alert({
																		 template: "<div ><p>Doctor did not accept your request.<br>Would you like to send request to all available doctors?</p></div>",
																		 cssClass: 'requestPopup',
																		 scope: $scope,
																		 buttons: [
																		 {
		 ...
		 if(newValue == 7 ) {
						//  alert('declined');
						 ...
						 var noResponsePopup = $ionicPopup.alert({
 							template: "<center><p>Doctor has not accepted your request.<br>Would you like to send request to all available doctors?</p></center>",
 							cssClass: 'requestPopup',
 							scope: $scope,
 							buttons: [
 							{
